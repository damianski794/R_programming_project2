...
wersja_data_table <- c('T','N','T','N','T')
testy_szybkosci <- c('N', 'N', 'N', 'N', 'N')
intepretacje_zapytan <- c('T', 'T', 'T', 'T', 'T')
head(data.frame(wersja_dyplr, wersja_f_bazowe, wersja_data_table, testy_szybkosci, intepretacje_zapytan))
```
